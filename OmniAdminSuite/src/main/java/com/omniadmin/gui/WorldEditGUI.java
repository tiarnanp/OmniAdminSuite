...
public class WorldEditGUI extends GuiBase implements Listener {
    ...
    public void open(Player admin) {
        ...
        gui.setItem(23, make(Material.TNT,             "§c§lToggle TNT Damage",        "§7Current: "+(w.getGameRuleValue(GameRule.MOB_GRIEFING)?"§aON":"§cOFF")));
        gui.setItem(24, make(Material.OAK_SAPLING,     "§2§lToggle Leaf Decay",        "§7Current: "+(w.getGameRuleValue(GameRule.DO_FIRE_TICK)?"§aON":"§cOFF")));
    ...
    public void onClick(InventoryClickEvent e) {
        ...
        switch (slot) {
            ...
            case 23 -> toggle(admin, w, GameRule.MOB_GRIEFING, "tntExplodes");
            case 24 -> toggle(admin, w, GameRule.DO_FIRE_TICK, "leavesDecay");
            case 25 -> {
